...
def recommend_pqc_migration(asset: CryptoAsset) -> MigrationRecommendation:
    """
    ...
    if asset.primitive_type == PrimitiveType.KEY_EXCHANGE or any(k in alg_upper for k in ["ECDH", "DH", "X25519"]):
        return MigrationRecommendation(
            ...
            recommended_hybrid="X25519MLKEM768 (ECDHE-ML-KEM Hybrid)",
            recommended_pqc_standalone="ML-KEM-768 (NIST FIPS 203)",
